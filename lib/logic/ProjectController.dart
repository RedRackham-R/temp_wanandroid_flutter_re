...
import 'package:wanandroid_flutter_re/model/ProjectModel.dart';
import 'package:wanandroid_flutter_re/model/WechatModel.dart';

class ProjectController extends BaseWanDefaultController<List<TabTagEntity>> {
  static const String tag = "ProjectController";

  ///单例创建对象 WechatController 需要持久化 所以不需要每次都创建
  static ProjectController? _instance;

  static ProjectController get instance {
    _instance ??= ProjectController._internal();
  ...
  @override
  BaseWanDefaultModel creatModel() => ProjectModel();
}
